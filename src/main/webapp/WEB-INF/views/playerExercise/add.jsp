...
<html>
<head>
    <title>Dodaj Ćwiczenie Zawodnika</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
<div class="container mt-5">
    <h1>Dodaj Ćwiczenie Zawodnika</h1>
    <form:form action="${pageContext.request.contextPath}/playerExercise/add" method="post" modelAttribute="playerExercise" class="needs-validation">
