...
<html>
<head>
    <title>Edytuj Sesję Treningową</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
<div class="container mt-5">
    <h1>Edytuj Sesję Treningową</h1>
    <form:form action='/trainingSession/edit/${trainingSession.id}' method="post" modelAttribute="trainingSession"
        ...
        <div class="form-group">
            ...
            <form:select path="place.id" items="${places}" id="place" itemValue="id" itemLabel="placeName"
                         class="form-control"/>
